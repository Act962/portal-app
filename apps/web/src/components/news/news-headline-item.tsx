	...
	return (
		<li className="border-hairline border-t">
			<Link
				...
				className="flex gap-3 py-2.5 text-brand-ink hover:text-brand-ink"
			>
				<Timestamp
				...
				/>
				<span className="flex-1 text-pretty font-semibold text-[15px] leading-snug hover:text-brand-accent-ink">
					{article.title}
				</span>
			</Link>
		</li>
