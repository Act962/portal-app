...
function Checkbox({ className, ...props }: CheckboxPrimitive.Root.Props) {
	return (
		...
		>
			...
			>
				{/* Traço, e não check, no estado indeterminado: "parte da lista está
				    marcada" e "tudo está marcado" precisam ser distinguíveis de
				    relance — é a diferença entre arquivar 3 e arquivar 20. */}
